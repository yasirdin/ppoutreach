...
//user avatar:
ppoutreach.directive('userAvatar', function() {
    return {
        replace: true,
...
//exposing current state name to $rootscope, so they can be printed into the toolbar:
ppoutreach.run(['$rootScope', '$state', '$stateParams', function($rootScope, $state, $stateParams) {
    $rootScope.$state = $state;
